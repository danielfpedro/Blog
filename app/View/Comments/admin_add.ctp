...
<?php
	...
	?>
	<fieldset>
		<legend><?php echo __('Adicionar  Comment'); ?></legend>
	<?php
		echo $this->Form->input('body', array('empty'=> 'Selecione:','class'=> 'form-control'));
		echo $this->Form->input('post_id', array('empty'=> 'Selecione:','class'=> 'form-control'));
		echo $this->Form->input('reader_id', array('empty'=> 'Selecione:','class'=> 'form-control'));
	?>
	</fieldset>
