<div class="users index">
	...
	<?php
	$label = 'Adicionar User';
	$path = array('controller'=> 'users', 'action'=> 'add');
...
?>
	...
	<tr>
		...
		<td>
			<?php echo $this->Html->link($user['UsersRole']['name'], array('controller' => 'users_roles', 'action' => 'view', $user['UsersRole']['id'])); ?>
		</td>
		<td class="actions">
